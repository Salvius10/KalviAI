                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mt-1.5 text-xs text-black/70 flex-wrap">
                        ...
                        {isPdfAssignment ? (
                          <span>📄 Upload PDF or photo of handwritten work</span>
                        ) : (
                          <>
                    ...
                    {isPdfAssignment ? (
                      <div className="w-full max-w-xs space-y-3">
                        {submission ? (
                          ...
                          <>
                            <p className="text-xs text-black/60 mb-1">PDF or photo of handwritten work (JPG, PNG, WEBP)</p>
                            <input
                              type="file"
                            ...
                            >
                              {dueState.isOverdue ? 'Deadline passed' : submitting ? 'Uploading...' : 'Submit Assignment'}
                            </button>
                          </>
                        )}
                      </div>
